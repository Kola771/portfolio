        ...
        <div class="lg:w-[80rem] lg:p-6 lg:m-auto">
            ...
            <p class="my-5 text-white p-2 flex flex-wrap gap-3">
                <a class="rounded-full w-[140px] relative" href="https://github.com/Kola771" target="blank">
                    ...
                    <span
                        class="absolute top-[20px] right-0 bg-[#FFF] text-[#333] rounded-full p-0.5 animated-element">Lien
                        Github</span>
                </a>
            </p>
        </div>
...
.animated-element {
  opacity: 0;
  transition: opacity 0.5s ease; /* Ajoutez d'autres propriétés de transition au besoin */
}

a:hover>.animated-element {
  opacity: 1;
}
</style>