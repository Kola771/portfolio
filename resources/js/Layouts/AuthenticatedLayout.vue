...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            ...
            <div
                class="fixed w-full z-30 flex bg-white text-black dark:bg-[#0F172A] p-2 items-center justify-center h-16 px-10">
                <div
                    class="logo ml-12 dark:text-white transform ease-in-out duration-500 flex-none h-full flex items-center justify-center">
                    <Link class="dark:text-white text-black" href="/">MyFolio/Dashboard</Link>
                </div>
                <!-- SPACER -->
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('profile.edit')"> Voir son profil </DropdownLink>
            ...
            <aside
                ...
                <div
                    ...
                    <div
                        class="flex items-center space-x-3 group bg-gradient-to-r dark:from-[#FFA500] dark:to-blue-500 from-indigo-500 via-purple-500 to-purple-500  pl-10 pr-2 py-1 rounded-full text-white  ">
                        <div class="transform ease-in-out duration-300 mr-12">
                            <Link class="dark:text-white text-black" href="/">MyFolio</Link>
                        </div>
                    </div>
                </div>
                <div @click="openNav()"
                ...
                <div class="max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
                    <div
                        class="hover:ml-4 w-full text-black dark:text-white hover:text-purple-500 dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
                        ...
                        <div>
                            <Link class="dark:text-white text-black" :href="route('dashboard')">Accueil</Link>
                        </div>
                    </div>
                    <div
                        class="hover:ml-4 w-full text-black dark:text-white hover:text-purple-500 dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
                        ...
                        <div>
                            <Link class="dark:text-white text-black" :href="route('addVue')">Projets</Link>
                        </div>
                    </div>
                    <div
                        class="hover:ml-4 w-full text-black dark:text-white hover:text-purple-500 dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
                        ...
                        <div>
                            <Link class="dark:text-white text-black" :href="route('vueContacts')">Messages</Link>
                        </div>
                    </div>
                </div>
                <!-- MINI SIDEBAR-->
